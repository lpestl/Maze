...
Для генерации лабиринта воспользуемся алгоритмом Эллера для построения односвязного лабиринта.
